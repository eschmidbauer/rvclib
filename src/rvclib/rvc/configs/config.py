...
version_config_paths = [
    os.path.join(config_path, "v1", "32000.json"),
    os.path.join(config_path, "v1", "40000.json"),
    os.path.join(config_path, "v1", "48000.json"),
    os.path.join(config_path, "v2", "48000.json"),
    os.path.join(config_path, "v2", "40000.json"),
    os.path.join(config_path, "v2", "32000.json"),
]
